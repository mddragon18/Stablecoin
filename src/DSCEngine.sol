...
contract DSCEngine is ReentrancyGuard {
     ...
     */
    function depositCollateralAndMintDSC(address _tokenCollateralAddress,uint256 amountCollateral,uint256 amountDSCToMint) external {
     ...
     */
    function depositCollateral(address _tokenCollateralAddress,uint256 amount) public moreThanZero(amount) isAllowedToken(_tokenCollateralAddress) nonReentrant {
    ...
    function getTokenAmountFromUSD(address collateral, uint256 amountInUsd) public view moreThanZero(amountInUsd) returns(uint256 amountOfToken) {
    ...
    function _getAccountInformation(address user) internal view returns (uint256 _totalDscMinted, uint256 _totalCollateralValue) {
